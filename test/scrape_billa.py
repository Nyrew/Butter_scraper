    ...
    for url in urls:
        ...
        if response.status_code == 200:
            ...
            try:
                ...
                name = tree.xpath('//h1[@class="ws-product-slug-main__title text-base-color h2 ml-md-2"]/text()')#'//h1[@class="product-details-tile__title"]/text()')
                print("got name")
